            ...
            <ul className="inline-flex items-center -space-x-px">
                {activePage > 1 && <li className="cursor-pointer">
                    <div
                        ...
                        className="block py-2 px-3 ml-0 leading-tight text-gray-500 bg-white hover:bg-blue-100 hover:text-blue-700"
                    >
                ...
                {arr.map(p => (
                    <li key={p} className="cursor-pointer">
                        <div onClick={() => setActivePage(p)}
                            className={`leading-tight ${p !== activePage ? 'py-2 px-3 text-gray-500 bg-white hover:bg-blue-100 hover:text-blue-700' : 'py-2 px-4 text-white bg-gray-600 rounded-full mx-3'}`}
                        >
                            {p}
                        </div>
                    </li>
                ...
                {activePage < arr.length && <li className="cursor-pointer">
                    <div onClick={() => setActivePage(activePage + 1)}
                        className="block py-2 px-3 leading-tight text-gray-500 bg-white hover:bg-blue-100 hover:text-blue-700"
                    >
